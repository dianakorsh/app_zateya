...
export const ACTIVITIES: Activity[] = [
  {
    ...
    category: 'еда', audience: 'для всех',
    title: 'Церемония чайная, эмоции личные',
    schedule: 'ежедневно', price: 900, distance: 3.1,
  ...
  },
  {
    ...
    category: 'культура', audience: 'для всех',
    title: 'Озеленить дом',
    schedule: 'ежедневно', price: 1500, distance: 4.9,
  ...
  },
  {
    ...
    category: 'спорт', audience: 'для всех',
    title: 'Велопрогулка по набережной',
    schedule: 'сб-вс', price: 500, distance: 1.2,
  ...
  },
  {
    ...
    category: 'ночная жизнь', audience: 'для компании',
    title: 'Барная вечеринка в стиле Techno',
    schedule: 'пт-сб', price: 1800, distance: 2.7,
  ...
  },
  {
    ...
    category: 'культура', audience: 'один',
    title: 'Выставка современного искусства',
    schedule: 'вт-вс', price: 600, distance: 5.3,
  ...
  },
  {
    ...
    category: 'еда', audience: 'в паре',
    title: 'Кулинарный мастер-класс',
    schedule: 'ср, пт', price: 3500, distance: 3.8,
  ...
  },
  {
    ...
    schedule: 'пн, ср, пт', price: 0, distance: 0.8,
  ...
  },
  {
    ...
    schedule: 'каждое воскресенье', price: 200, distance: 2.1,
